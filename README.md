...
1.10. "수정"
    ...
    (b) 적용 대상을 포함하는 소스 코드 형식의 모든 새 파일
        소프트웨어.
...
(b) 귀하는 본 조건에 따라 그러한 실행 양식을 배포할 수 있습니다.
...
5.1. 이 라이선스에 따라 부여된 권리는 자동으로 종료됩니다.
...
-------------------------------------------
  ...
  이 소스 코드 양식은 Mozilla Public의 조건을 따릅니다.
